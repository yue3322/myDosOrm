...
namespace testorm.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var crt = new UseShipOrderCriteria { UsoId = 128691161879305 };
            var newuso = UseShipOrderList.Fetch(crt);
            var criteria = new UseShipOrderCriteria();
            criteria.UseQuerySql = true;
            criteria.QuerySqlCommand = "select * from use_ship_order where    uso_id = 128691161879305 ";
            var uso = UseShipOrderList.Fetch(criteria);
            return null;
        }
        //
        // POST: /Account/Login
